...
public class StationController implements StationsApi {
    ...
    @Override
    public ResponseEntity<StationSearchResponse> searchStations(StationSearchMode searchMode, Integer page, Integer size, Double lat, Double lng, Integer radiusMeters, Double north, Double south, Double east, Double west, ProductType productType, StationSearchSortBy sortBy, Integer limit) {
